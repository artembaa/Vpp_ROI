...
//*********************************************************
//			 ќѕ–≈ƒ≈Ћ≈Ќ»я, —¬я«јЌЌџ≈ — ќЅ–јЅќ“ ќ…
//*********************************************************
#define DIV_N(divident,divisor) ((divident)/(divisor))

// ќпределени¤ дл¤ входного изображени¤ (RI - Rastr Input)
#define   RI_X			 1008 /* пикселей, должен быть „≈“Ќџћ и кратным S_ITEM_SIZE (7) */
#define   RI_Y			 1008 /* пикселей, должен быть „≈“Ќџћ и кратным S_ITEM_SIZE (7) */
#define   RI_XY			 (RI_X*RI_Y) 
#define   RI_MIN		 96 

// ќпределени¤ дл¤ матрицы (S - Stream matrix)
#define   S_EXPANDER    3 /* ¤чейки матрицы */
#define   S_ITEM_SIZE   7 /* размер ¤чейки матрицы в пиксел¤х */
...
// ќпределени¤ дл¤ расширенного изображени¤ (R - Rastr)
